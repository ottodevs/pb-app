...
const ProjectCard = ({ name, description, endDate }: ProjectCardProps) => (
  <Card className="bg-white bg-opacity-10 text-white">
    ...
    <CardContent>
      ...
      <p className="text-xs mt-2 text-gray-400">Ends on: {endDate}</p>
    </CardContent>
  </Card>
);
...
const Dashboard = () => {
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white overflow-hidden">
      <main className="flex-grow overflow-y-auto p-4 space-y-6 animate-fadeIn">
